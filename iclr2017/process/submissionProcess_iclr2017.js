function () {
  ...
  var officialReviewInvitation = {
    ...
    'reply': {
      'forum': note.id, 
      'replyto': note.id,
      'writers': {'values-regex':'ICLR.cc/2017/conference/paper'+note.number+'/AnonReviewer[0-9]+'},
      'signatures': {'values-regex':'ICLR.cc/2017/conference/paper'+note.number+'/AnonReviewer[0-9]+'},
      'readers': { 
        'values': ['everyone'], 
        'description': 'The users who will be allowed to read the above content.'
      },
  ...
  var reviewerQuestionInvite = {
    ...
    'reply': {
      ...
      'signatures': {
        'values-regex':'ICLR.cc/2017/conference/paper'+note.number+'/AnonReviewer[0-9]+',
        'description': 'How your identity will be displayed with the above content.' 
        },    // this regex demands that the author reveal his/her ~ handle
      'writers': {'values-regex':'ICLR.cc/2017/conference/paper'+note.number+'/AnonReviewer[0-9]+'},    // this regex demands that the author reveal his/her ~ handle
      'readers': { 
        'values': ['everyone'], 
        'description': 'The users who will be allowed to read the above content.'
  ...
  var referenceInvite = {
    id: 'ICLR.cc/2017/conference/-/Add/Revision',
    signatures: ['ICLR.cc/2017/conference'],
    writers: ['ICLR.cc/2017/conference'],
