...
pw = ''
gdoc_link = ''
subject = '[UAI 2018 - SPC] Request for Recommended Reviewers'

message = '''
Dear Senior Program Chair,

Thank you for accepting our invitation to serve on the UAI 2018 senior program committee. We have an outstanding committee, with broad coverage of UAI related topics, and we are looking forward to working together.
