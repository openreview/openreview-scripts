...
var SUBMISSION_ID = 'aclweb.org/NAACL/2022/Conference/-/Special_Theme_Submission';
...
var getReviewerNoteNumbers = function() {
  return Webfield.getAll('/groups', {
    ...
    _.forEach(reviewerGroups, function(reviewerGroup) {
      ...
      var anonGroup = anonGroups.find(function(anonGroup) { return anonGroup.id.startsWith(CONFERENCE_ID + '/Paper' + num + '/Special_Theme_Ethics_Reviewer_'); });
      if (anonGroup) {
