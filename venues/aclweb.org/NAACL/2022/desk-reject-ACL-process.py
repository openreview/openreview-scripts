def process(client, note, invitation):
    ...
    DESK_REJECTED_SUBMISSION_ID = 'aclweb.org/NAACL/2022/Conference/-/Desk_Rejected_Commitment_Submission'
    ...
    invitation_regex = CONFERENCE_ID + '/Commitment' + str(forum_note.number) + '/-/.*'
