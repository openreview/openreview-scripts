def process_update(client, edge, invitation, existing_edge):
    ...
    GROUP_ID = 'aclweb.org/NAACL/2022/Conference/Ethics_Reviewers'
    PAPER_GROUP_ID = 'aclweb.org/NAACL/2022/Conference/Commitment{number}/Ethics_Reviewers'
    print(edge.id)
    print(invitation.id)
    print(existing_edge)
...
NAACL 2022 Conference Ethic Chairs'''
