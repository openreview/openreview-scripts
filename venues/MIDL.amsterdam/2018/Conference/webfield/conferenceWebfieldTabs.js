...
var PAGE_SIZE = 150;
var DECISION = 'MIDL.amsterdam/2018/Conference/-/Paper.*/Acceptance_Decision'
...
function render(notes, decisionNotes) {
  ...
  Webfield.ui.searchResults(
    oralDecisions,
    _.assign({}, paperDisplayOptions, {showTags: false, container: '#oral-papers'})
  );

  Webfield.ui.searchResults(
    posterDecisions,
    _.assign({}, paperDisplayOptions, {showTags: false, container: '#poster-papers'})
  );
