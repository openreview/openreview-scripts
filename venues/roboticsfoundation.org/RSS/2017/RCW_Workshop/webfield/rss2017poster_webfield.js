...
$attach('#header', 'mkHostHeader', [
  "RSS 2017 Workshop - Poster Track",
...
var invitationP = httpGetP('invitations', {id: 'roboticsfoundation.org/RSS/2017/RCW_Workshop/-_Poster/-/Submission'}).then(function(result) {
...
var getNotes = function() {
  return httpGetP('notes', {invitation: 'roboticsfoundation.org/RSS/2017/RCW_Workshop/-_Poster/-/Submission'}).then(function(result) {
    return result.notes;
  },
  function(error){
    return error;
