...
username=input("Your OpenReivew login email address:")
password=str(getpass("Password for ({}): ".format(username)))

client = openreview.Client(baseurl='https://devapi.openreview.net', username=username, password=password)
