...
def freeze_note(note, writers=[conferenceConfig.CONFERENCE_ID]):
...
def post_blind_note(client, original_note):
    ...
    paper_group_id = conferenceConfig.CONFERENCE_ID + "/Paper{}".format(blind_note.number)
    author_group_id = conferenceConfig.CONFERENCE_ID + "/Paper{}/Authors".format(blind_note.number)
