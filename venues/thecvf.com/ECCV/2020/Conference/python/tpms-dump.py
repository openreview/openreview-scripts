...
if not os.path.exists('eccv2020_users'):
	os.makedirs('eccv2020_users')

# At this point, all reviewers & ACs should have been
# converted to profile IDs and deduplicated.

valid_reviewer_profiles = {'reviewers' : get_valid_profiles(client, 'thecvf.com/ECCV/2020/Conference/Reviewers')}

valid_ac_profiles = {'areachairs' : get_valid_profiles(client, 'thecvf.com/ECCV/2020/Conference/Area_Chairs')}
...
for profile_group in all_user_profiles:
    ...
    with open('./eccv2020_users/tpms-{}-dump.csv'.format(user_type), 'w') as f:
        writer = csv.writer(f)
