function () {
  ...
  var SHORT_PHRASE = 'MIC 2018 Abstract';
  var CONFERENCE_ID = 'machineintelligence.cc/MIC/2018/Abstract';


    // send author a confirmation email
  var author_mail = {
    groups: note.content.authorids,
    subject: 'Your abstract submission to ' + SHORT_PHRASE + ' has been received: "' + note.content.title + '"',
    message: 'Your abstract submission to ' + SHORT_PHRASE + ' has been posted.\n\nTitle: ' + note.content.title + '\n\nAbstract: ' + note.content.abstract + '\n\nTo view your submission, click here: ' + baseUrl + '/forum?id=' + note.forum
  };
