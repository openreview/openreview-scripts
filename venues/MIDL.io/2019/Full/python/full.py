...
submission_content = {
    ...
    'conduct': {
        ...
        'value-dropdown': ['I have read and accept the code of conduct.', 'I do not accept the code of conduct.'],
        'required': True
    },
    'remove': {
        'order': 12,
        'value-dropdown': ['Remove submission if paper is rejected.', 'Keep submission.'],
        'required': True
    }
}