...
// Constants
var HEADER_TEXT = 'MIDL 2019 Area Chair Console';
...
var getFullNotes = function(noteNumbers) {
  ...
  return $.getJSON('notes', { invitation: SUBMISSION_ID, number: noteNumbersStr, noDetails: true })
