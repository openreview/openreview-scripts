...
var INVITATION = CONFERENCE + '/-/Abstract_Submission';
var BLIND_INVITATION = CONFERENCE + '/-/Abstract_Submission';
...
var displayPCStatusTable = function(profiles, notes, completedReviews, metaReviews, reviewerByNote, reviewerById, container) {
  var rowData = [];
  var index = 1;
  ...
  token: function(token) {
    ...
    .then(function(blindedNotes, officialReviews, metaReviews, reviewerGroups, areaChairGroups) {
      ...
      .then(function(profiles) {
        ...
        //displayPCStatusTable(profiles, blindedNotes, officialReviews, metaReviews, reviewerGroups.byNotes, reviewerGroups.byReviewers);
