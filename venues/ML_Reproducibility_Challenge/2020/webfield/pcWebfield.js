...
var SHORT_PHRASE = 'RC2020';
var SUBMISSION_ID = 'ML_Reproducibility_Challenge/2020/-/Submission';
var BLIND_SUBMISSION_ID = 'ML_Reproducibility_Challenge/2020/-/Submission';
...
var HEADER = {"title": "Program Chairs Console", "instructions": "<p class=\"dark\">This page provides information and status             updates for the RC2020. It will be regularly updated as the conference             progresses, so please check back frequently.</p>"};
...
var getNeurIPSNotes = function() {
  return Webfield.getAll('/notes', {
    invitation: ACCEPTED_PAPER_ID, noDetails: true
  });
};
...
//    console.log("getReportNotes()",  getReportNotes().length);
    getReportNotes()
    .then(function(notes) {
...
//      console.log("uniqueReviewerIds", uniqueReviewerIds);
