...
groups = {}
groups[config.PROGRAM_CHAIRS] = openreview.Group(config.PROGRAM_CHAIRS, members=['spector@cs.umass.edu','ruben@verborgh.org', 'asambra@mit.edu', 'kuhntobias@gmail.com'], **config.group_params)
