function(){
    const CONFERENCE = 'informatik.uni-rostock.de/Informatik_Rostock/Ubiquitous_Computing/2017';
    const CONFERENCE_NAME = "the Recent Advances in Ubiquitous Computing course";
