...
def main():
    ...
    submissions = client.get_notes(invitation='ICLR.cc/2018/Workshop/-/Acceptance_Decision')
    ...
    for note in submissions:
        if note.forum in decision_info:
            authors.extend(note.forumContent.get("authorids"))
    # remove duplicates
