function () {
  ...
  var bidProcess = function(){
    ...
    or3client.or3request(or3client.notesUrl+'?invitation=auai.org/UAI/2017/-/reviewer_bid_tracking',{},'GET',token)
    .then(function(result){
    	console.log('result of get by invitation:',result);
    	var filtered_notes = result.notes.filter(function(n){
    		return n.content.reviewer.indexOf(note.signatures[0])>-1;
    	});
    	console.log(filtered_notes);
    	filtered_notes[0].content.count+=1
    })
    .then(function(filtered_notes){
