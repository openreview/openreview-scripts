function() {
  ...
  if(hashKey == note.content.key) {
    if (note.content.response == 'Yes') {
      ...
      or3client.removeGroupMember('UAI.org/2017/conference/Sr_Program_Committee/declined', note.content.username, token)
      or3client.addGroupMember('UAI.org/2017/conference/Sr_Program_Committee', note.content.username, token)
      ...
      or3client.removeGroupMember('UAI.org/2017/conference/Sr_Program_Committee', note.content.username, token)
      or3client.addGroupMember('UAI.org/2017/conference/Sr_Program_Committee/declined', note.content.username, token)
      .then(function(result) {
