function() {
  ...
  if(hashKey == note.content.key) {
    if (note.content.response == 'Yes') {
      ...
      or3client.removeGroupMember('auai.org/UAI/2017/SPC/declined', note.content.username, token)
      or3client.addGroupMember('auai.org/UAI/2017/SPC', note.content.username, token)
      ...
      or3client.removeGroupMember('auai.org/UAI/2017/SPC', note.content.username, token)
      or3client.addGroupMember('auai.org/UAI/2017/SPC/declined', note.content.username, token)
      .then(function(result) {
