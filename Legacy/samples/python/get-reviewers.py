...
parser.add_argument('conference',help="the base path of the conference whose reviewers you would like to see. This should correspond to the prefix of the submission invitation. (E.g. if the submission invitation is ICLR.cc/2017/conference/-/submission, the prefix is ICLR.cc/2017/conference")
...
if args.paper_number!=None:
    ...
    try:
        note = notes[0]
        message = []
        reviewers = openreview.get_group(args.conference+'/paper'+str(note.number)+'/reviewers');
...
if args.user!=None:
    user = args.user
    groups = openreview.get_groups(member=user,regex=args.conference+'/paper[0-9]+/reviewer[0-9]+')
