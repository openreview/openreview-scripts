...
for paper in blind_submissions:
    ...
    comment_parameters['reply'] = {
        'forum': paper.id,
        'replyto': None,
        'writers': {'values-regex': paperGroup + '/Authors'},
        'signatures': {'values-regex': paperGroup + '/Authors'},
        'readers': {
            'values': ['everyone'],
    ...
    invite = openreview.Invitation(paperinv + '/Anonymous_Comment', **comment_parameters)
