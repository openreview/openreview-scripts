function() {
  ...
  if(hashKey == note.content.key) {
    if (note.content.response == 'Yes') {
      ...
      or3client.removeGroupMember('ICLR.cc/2018/Conference/Area_Chairs/Declined', note.content.username, token)
      or3client.addGroupMember('ICLR.cc/2018/Conference/Area_Chairs', note.content.username, token)
      ...
      or3client.removeGroupMember('ICLR.cc/2018/Conference/Area_Chairs', note.content.username, token)
      or3client.addGroupMember('ICLR.cc/2018/Conference/Area_Chairs/Declined', note.content.username, token)
      .then(function(result) {
