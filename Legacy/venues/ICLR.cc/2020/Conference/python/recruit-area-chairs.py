...
if __name__ == '__main__':
    ...
    message = '''Dear {name},
        ...
        You have been nominated by the program chair committee of ICLR 2020 to serve as an area chair.  As a respected researcher in the area, we hope you will accept and help us make the conference a success.
    ...
    emails = ['ac_iclr2020@mail.com', 'ac2_iclr2020@mail.com', '~Melisa_Bok1']

    conference.recruit_reviewers(emails= emails, reviewers_name = 'Area_Chairs', title = title , message = message)