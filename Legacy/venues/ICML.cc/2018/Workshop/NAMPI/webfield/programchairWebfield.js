...
// Constants
var HEADER_TEXT = 'ICML NAMPI 2018 Program Chairs Console';

var CONFERENCE = 'ICML.cc/2018/Workshop/NAMPI';
...
var ANONREVIEWER_REGEX = /^ICML\.cc\/2018\/Workshop\/NAMPI\/Paper(\d+)\/AnonReviewer(\d+)/;
var AREACHAIR_REGEX = /^ICML\.cc\/2018\/Workshop\/NAMPI\/Paper(\d+)\/Area_Chair/;
...
var displayPaperStatusTable = function(profiles, notes, completedReviews, metaReviews, reviewerIds, container, options) {
...
controller.addHandler('areachairs', {
  token: function(token) {
    ...
    .then(function(blindedNotes, officialReviews, metaReviews, reviewerGroups, loaded) {
      ...
      .then(function(profiles) {
        displayPaperStatusTable(profiles, blindedNotes, officialReviews, metaReviews, reviewerGroups.byNotes, '#paper-status');
...
$('#group-container').on('click', 'a.send-reminder-link', function(e) {
  ...
  var postData = {
    subject: 'ICML Workshop NAMPI 2018 Reminder',
    message: 'This is a reminder to please submit your official reviews for ICML Workshop NAMPI 2018. ' +
      'Click on the link below to go to the review page:\n\n' + 'https://openreview.net' + forumUrl + '\n\nThank you.',
    groups: [userId]
  };
