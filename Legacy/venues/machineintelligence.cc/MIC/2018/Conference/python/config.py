...
CONFERENCE_ID = 'machineintelligence.cc/MIC/2018/Conference'
...
SUBMISSION_TIMESTAMP = tools.timestamp_GMT(2018, month=10, day= 15, hour=23)
REVIEW_TIMESTAMP = tools.timestamp_GMT(2018, month=10, day= 30, hour=23)
...
JS_CONSTANTS = {
    ...
    'PROGRAM_CHAIRS': PROGRAM_CHAIRS,
    'REVIEWERS': REVIEWERS,
    'SUBTITLE': 'MIC 2018 Conference',
    'TITLE': 'Machine Intelligence Conference',
    'DEADLINE_STRING': 'October 1st, 2018',
    'CONF_DATE_STRING': 'November 3rd, 2018',
    'INSTRUCTIONS': '  ',
    'WEBSITE': 'https://machineintelligence.cc',
