...
# ex. python get-submissions.py --output submissions.csv
###############################################################################
...
notes = client.get_notes(invitation='IEEE.org/2018/ITSC/-/Submission')
if args.output!=None:
    ...
    if ext.lower()=='json':
        ...
        with open(args.output, 'wb') as outfile:
            ...
            fieldnames = ['id', 'number', 'title', 'abstract','keywords','authors','authorids']
