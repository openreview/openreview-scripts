...
subjectline = "Reviews due Wednesday for MIDL Conference track"

message = """
Hi,

This is a final reminder that your MIDL paper reviews are due by the end of Wednesday, May 2.

Reminder: Log into OpenReview using the same email address as used in this email.  Go to the "Tasks" under your name.
