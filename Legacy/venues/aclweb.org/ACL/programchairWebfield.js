...
var COMMITMMENT_SUBMISSION_ID = 'aclweb.org/ACL/2022/Conference/-/Commitment_Submission';
var WITHDRAWN_SUBMISSION_ID = 'aclweb.org/ACL/2022/Conference/-/Withdrawn_Submission';
var DESK_REJECTED_SUBMISSION_ID = 'aclweb.org/ACL/2022/Conference/-/Desk_Rejected_Submission';
...
var displayCommitmentStatusTable = function() {
  ...
  var postRenderTable1 = function(data, pageNum) {
    ...
    $('.console-table th').eq(1).css('width', '97%');
...
var displayPaperStatusTable = function() {
  ...
  var postRenderTable2 = function(container, data, pageNum) {
    ...
    if (AREA_CHAIRS_ID) {
      ...
      $(container + ' .console-table th').eq(3).css('width', '23%');
...
var buildPaperTableRow = function(note) {
  ...
  var areachairProgressData = {
    ...
    referrer: paperTableReferrerUrl,
    // actions: [
    //   { name: 'Assigned SACs', url: '/group/info?id=aclweb.org/ACL/2022/Conference/' + sacNameDictionary[note.content.track] + '/Senior_Area_Chairs' },
    //   { name: 'Conflicts detected', url: '/group/info?id=aclweb.org/ACL/2022/Conference/Paper' + note.number + '/Conflicts' }
    // ]
  };
