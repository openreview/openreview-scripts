def process_update(client, edge, invitation, existing_edge):
    ...
    SHORT_PHRASE = 'ACL 2022 Conference'
    GROUP_ID = 'aclweb.org/ACL/2022/Conference/Ethics_Reviewers'
    PAPER_GROUP_ID = 'aclweb.org/ACL/2022/Conference/Paper{number}/Ethics_Reviewers'
    print(edge.id)
    print(invitation.id)
    print(existing_edge)
    ...
    if not edge.ddate and edge.tail not in group.members:
        ...
        subject=f'[{SHORT_PHRASE}] You have been assigned as a Ethic Reviewer for paper number {note.number}'
        message=f'''This is to inform you that you have been assigned as a Ethic Reviewer for paper number {note.number} for {SHORT_PHRASE}.
...
ACL 2022 Conference Ethic Chairs'''
