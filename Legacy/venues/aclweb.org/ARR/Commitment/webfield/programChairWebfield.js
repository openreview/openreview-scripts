// Constants
var CONFERENCE_ID = 'aclweb.org/ACL/2022/Workshop/WASSA';
var SHORT_PHRASE = 'WASSA 2022';
var SUBMISSION_ID = 'aclweb.org/ACL/2022/Workshop/WASSA/-/Submission';
var COMMITMENT_SUBMISSION_ID = 'aclweb.org/ACL/2022/Workshop/WASSA/-/Commitment_Submission';
var BLIND_SUBMISSION_ID = 'aclweb.org/ACL/2022/Workshop/WASSA/-/Submission';
var WITHDRAWN_SUBMISSION_ID = 'aclweb.org/ACL/2022/Workshop/WASSA/-/Withdrawn_Submission';
var DESK_REJECTED_SUBMISSION_ID = 'aclweb.org/ACL/2022/Workshop/WASSA/-/Desk_Rejected_Submission';
var HEADER = {"title": "Program Chairs Console", "instructions": "<p class=\"dark\">This page provides information and status             updates for the WASSA 2022. It will be regularly updated as the conference             progresses, so please check back frequently.</p>"};
...
var AUTHORS_ID = 'aclweb.org/ACL/2022/Workshop/WASSA/Authors';
var REVIEWERS_ID = 'aclweb.org/ACL/2022/Workshop/WASSA/Reviewers';
var AREA_CHAIRS_ID = '';
var SENIOR_AREA_CHAIRS_ID = '';
var PROGRAM_CHAIRS_ID = 'aclweb.org/ACL/2022/Workshop/WASSA/Program_Chairs';
var REQUEST_FORM_ID = 'HmDsMzqcVhW';
...
var getCommitmentNotes = function() {
  return Webfield.getAll('/notes', {
    invitation: COMMITMENT_SUBMISSION_ID,
...
var displayCommitmentStatusTable = function() {
  ...
  var rowData = _.map(conferenceStatusData.commitmentNotes, function(note) {
    return buildCommitmentTableRow(note);
  });
  ...
  var searchResults = function(searchText, isQueryMode) {
    ...
    $(container + " .btn-export-commitments").text("Export " + filteredRows.length + " records");
  };
  ...
  var postRenderTable = function(data, pageNum) {
    ...
    $('.console-table th').eq(2).css('width', '47%');
  ...
  if (rowData.length) {
    ...
    $(container).find('form.search-form .pull-left').html('<div class="btn-group"><button class="btn btn-export-commitments" type="button">Export ' + rowData.length + ' records</button></div>');
...
var buildCommitmentTableRow = function(note) {
...
$('#group-container').on('shown.bs.tab', 'ul.nav-tabs li a', function(e) {
  ...
  } else if (containerId === '#commitment-status') {
...
var buildCommitmentCSV = function(){
  var isFiltered = conferenceStatusData.filteredRows ? true : false
  var notes = isFiltered ? conferenceStatusData.filteredRows : conferenceStatusData.commitmentNotes
  ...
  _.forEach(notes, function(noteObj) {
    ...
    if(isFiltered){
      ...
      var paperTableRow = buildCommitmentTableRow(noteObj);
    }
...
$('#group-container').on('click', 'button.btn.btn-export-commitments', function(e) {
  var blob = new Blob(buildCommitmentCSV(), {type: 'text/csv;charset=utf-8'});
  var fileName = conferenceStatusData.filteredNotes ? SHORT_PHRASE.replace(/\s/g, '_') + '_commitment_status(Filtered).csv' : SHORT_PHRASE.replace(/\s/g, '_') + '_commitment_status.csv'
  saveAs(blob, fileName);
});
