    ...
    invitation = openreview.Invitation(id = f'{paper_group}/-/Review{review.number}/Rating',
                                ...
                                reply = {
                                    ...
                                    'readers': {
                                        ...
                                        'values': ['aclweb.org/NAACL/2022/Conference/Program_Chairs', sac_group]
                                    },
                                    'nonreaders': {
                                        'values': nonreaders
                                    },
...
reviews = list(tools.iterget_notes(client, invitation='aclweb.org/NAACL/2022/Conference/-/ARR_Official_Review', sort='number:asc'))
print(f'{len(reviews)} posted reviews')

for rev in tqdm(reviews):
    nonreaders = rev.nonreaders
    r = re.compile("aclweb.org/NAACL/2022/Conference/.*/Senior_Area_Chairs")
    try:
...
metareviews = list(tools.iterget_notes(client, invitation='aclweb.org/NAACL/2022/Conference/-/ARR_Meta_Review', sort='number:asc'))
